...
TraverseDirectories(rootDirectory, smallDirectories);

Console.WriteLine(smallDirectories.Sum(d => d.TotalSize));

void TraverseDirectories(Directory source, List<Directory> smallDirectories)
{
    ...
    {
        TraverseDirectories(directory, smallDirectories);
    }
}
